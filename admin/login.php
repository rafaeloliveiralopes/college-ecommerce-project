...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($identifier === '' || $password === '') {
    $error_message = 'Preencha usuário e senha para continuar.';
  } else {
    ...
    if ($stmt) {
      ...
      $error_message = 'Não foi possível processar o login.';
    }
  }
}
?>
<main class="container login-wrapper d-flex align-items-center justify-content-center py-5">
  <div class="card content-card w-100" style="max-width: 430px;">
    <div class="card-body p-4 p-md-5">
      <h1 class="h3 mb-3 text-center">Login do Painel</h1>
      <p class="text-muted text-center mb-4">Entre com o usuário administrador para acessar os pedidos.</p>
      ...
      <?php if ($flash) { ?>
        <div class="alert <?php echo admin_alert_class($flash['type']); ?>" role="alert">
