    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-3 col-md-6">
          <img src="assets/imgs/logo.svg?v=2" alt="Logo da loja" class="footer-logo mb-3">
          <p class="footer-text">Os melhores produtos pelo melhor preco.</p>
        </div>
        <div class="col-lg-3 col-md-6">
          <h5>Paginas</h5>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <ul class="list-unstyled footer-contact">
            <li>(11) 99999-0000</li>
            <li>contato@ecommercecms.com</li>
            <li>Rua do Comercio, 100 - Sao Paulo</li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-6">
          <h5>Destaques</h5>
